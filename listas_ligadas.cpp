...
int main() {
    ...
    ejemploLista.insertarInicio(5);
    ejemploLista.insertarInicio(4);
    ejemploLista.insertarInicio(3);
    ejemploLista.insertarInicio(2);

    ejemploLista.insertarFinal(6);
    ejemploLista.insertarFinal(7);
    ejemploLista.insertarFinal(8);
    ejemploLista.insertarFinal(9);

    cout << "Ingrese un numero a buscar en la lista ligada:";
    cin >> num;
    cout << ejemploLista.buscar(num);
